...
log_info "保存时 SE(3) 回环：enable=$MAPPING_LOOP_CLOSURE horizontal_search_radius=${MAPPING_LOOP_SEARCH_RADIUS}m"
...
launch_args=(
  ...
  "loop_closure:=$MAPPING_LOOP_CLOSURE"
  "loop_search_radius:=$MAPPING_LOOP_SEARCH_RADIUS"
)
