...
namespace scan_planner
{
  ...
  {
    getParam(nh, "optimization/lambda_smooth", lambda1_, -1.0);
  ...
  bool BsplineOptimizer::rebound_optimize()
  {
    ...
    do
    {
      ...
      double time_ms = elapsedMs(t1, t2);
      double total_time_ms = elapsedMs(t0, t2);
          ...
          result == lbfgs::LBFGS_STOP)
      {
        ...
        t_step = std::max(0.01, std::min(0.05, t_step));
