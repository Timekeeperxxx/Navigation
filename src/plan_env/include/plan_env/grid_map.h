...
#define ROS_ERROR(...) RCLCPP_ERROR(rclcpp::get_logger("plan_env"), __VA_ARGS__)
#define ROS_WARN(...) RCLCPP_WARN(rclcpp::get_logger("plan_env"), __VA_ARGS__)
#define ROS_ERROR_STREAM(args) RCLCPP_ERROR_STREAM(rclcpp::get_logger("plan_env"), args)
#define ROS_WARN_STREAM(args) RCLCPP_WARN_STREAM(rclcpp::get_logger("plan_env"), args)
#define ROS_WARN_THROTTLE(period, ...) RCLCPP_WARN(rclcpp::get_logger("plan_env"), __VA_ARGS__)
...
struct MappingData {
  ...
  uint32_t depth_image_width_;
  uint32_t depth_image_height_;
  int image_cnt_;
  // flags of map state
