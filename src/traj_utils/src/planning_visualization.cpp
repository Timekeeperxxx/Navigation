...
namespace scan_planner
{
  PlanningVisualization::PlanningVisualization(const rclcpp::Node::SharedPtr &nh)
  {
    ...
    guide_vector_pub = nh->create_publisher<visualization_msgs::msg::MarkerArray>("guide_vector", 2);
    intermediate_state_pub = nh->create_publisher<visualization_msgs::msg::MarkerArray>("intermediate_state", 2);
  }

  // // real ids used: {id, id+1000}
  void PlanningVisualization::displayMarkerList(const MarkerPublisher &pub, const vector<Eigen::Vector3d> &list, double scale,
  ...
  void PlanningVisualization::displayArrowList(const MarkerArrayPublisher &pub, const vector<Eigen::Vector3d> &list, double scale, Eigen::Vector4d color, int id)
  {
