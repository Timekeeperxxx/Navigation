...
namespace scan_planner
{
  ...
  private:
    ...
    double emergency_min_stop_duration_;
    double emergency_replan_period_;
    ...
    rclcpp::Time emergency_enter_time_;
    rclcpp::Time last_emergency_replan_time_;
    ...
    bool currentPlanningStartOccupied(const char *context);
