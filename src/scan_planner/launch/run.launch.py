...
def _setup(context, *args, **kwargs):
    ...
    scan_planner_params = {
        ...
        "grid_map/obstacles_inflation_radius": 0.20,
        "grid_map/double_cylinder_offset": 0.0,
        "grid_map/double_cylinder_center_offset": 0.0,
        "grid_map/obstacles_inflation_z_up": 1.65,
    ...
    if controller_mode == "open_loop":
        ...
        closed_loop_params = {
            ...
            "max_vy": 0.35,
            "max_vyaw": 1.0,
            "min_forward_x_speed": 0.25,
            "finish_dist": 0.15,
            "enable_final_yaw": True,
            "final_yaw_start_dist": 0.5,
            "final_yaw_tolerance": 0.4,
            "final_yaw_kp": 0.6,
            "final_yaw_max_vyaw": 0.5,
            "approach_slowdown_dist": 1.5,
            "approach_min_speed_scale": 0.5,
        }
        actions.append(
            Node(
                package="scan_planner",
